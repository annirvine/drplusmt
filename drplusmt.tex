...
We begin with a brief overview of the cross-lingual distributed representation setup of~\newcite{Klementiev-et-al:COLING2012}; we use features based on these representations in our translation lexicon induction experiments in \secref{sect:experiemtns}. 
